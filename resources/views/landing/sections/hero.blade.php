  ...
  <div class="wrap hero__grid">
    ...
    <div>
      <h1 class="hero__title hero-title">
        Votre identité professionnelle <span class="hero-mark">réinventée</span>
      </h1>

      <p class="hero__lead hero-lead">
        La plateforme d'identité numérique sécurisée pour l'élite professionnelle
    ...
    <div class="stage">
      <div class="float float--qr">
        ...
        <span class="label">QR Code généré</span>
      </div>
      ...
      <div class="float float--saved">
        ...
        <span class="label">Contact enregistré</span>
      </div>
    </div>
