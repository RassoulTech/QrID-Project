...
>
    ...
    <main class="pubc-page">
        ...
        {{-- `data-partage-url` porte l'adresse du compteur. Elle est ici et
             non dans le JavaScript : une adresse écrite en dur dans un module
             cesse d'être vraie au premier changement de route, sans que rien
             ne le signale. --}}
        <div id="partage" class="pubc__partage" role="dialog"
             data-partage-url="{{ route('profile.partage', $profile->slug) }}"
            ...
            <div class="pubc__partage-panneau">
                ...
                <button type="button" class="pubc__partage-action" data-partage-natif hidden data-partage-canal="natif"
                ...
                <button type="button" class="pubc__partage-action" data-partage-copier data-partage-canal="copie"
                        data-url="{{ url()->current() }}"
