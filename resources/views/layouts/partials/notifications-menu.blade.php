    ...
    <div class="dropdown-menu dropdown-menu-end notif-menu" aria-labelledby="menuNotifications">
        ...
        @empty
            ...
            <div class="notif-vide">
                ...
                {{-- L'AIDE DÉPEND DE L'ESPACE. La cloche est partagée par les
                     deux coques : en administration, elle annonçait « dès la
                     première consultation de VOTRE carte » à un exploitant qui
                     n'en a pas. `$espace` est passé par le gabarit appelant. --}}
                <span class="notif-vide__aide">
                    {{ ($espace ?? 'client') === 'admin'
                        ? __('navigation.notifications.vide_aide_admin')
